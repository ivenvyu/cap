...
TRAINING_SNAPSHOT = Path("data/review/phase1b/v2_2_5/training_snapshot_classifier_v2_2_5.jsonl")
FEATURE_GLOB = "data/feature_snapshots/v2_2_5/phase1b_duplicate_canonicalized/*.jsonl"

MODEL_OUT = Path("models/phase1b_smoke/classifier_smoke_model_v2_2_5.joblib")
REPORT_OUT = Path("audit/phase_1b/phase_1b_classifier_smoke_v2_2_5_jsonl.json")
...
def main() -> None:
    ...
    report = {
        "report_status": "classifier_smoke_training_diagnostic_v2_2_5_jsonl",
